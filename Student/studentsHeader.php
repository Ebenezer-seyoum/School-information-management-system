			...
			<div class="sidebar-content">
				<ul class="nav nav-secondary">
					<li class="nav-item active">
						<a href="judge.php" class="collapsed"><i class="fas fa-home"></i><p>judge</p></a>
					</li>
					<li class="nav-item">
					...
					<ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
						...
						<li class="nav-item topbar-user dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm"><img class="profile-img" src="#" alt="Profile Picture"></div>
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img class="profile-img" src="#" alt="Profile Picture"></div>
											<div class="u-text">
												<h4>Username</h4>
