  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <div class="card-title"><h3 class="fw-bold mb-4">Assigned Cases</h3></div>
      </div>
<div class="card-body">
...
<tr>
    ...
    <a href="Attach_file.php?case_id=<?= $case['case_id']; ?>&cid=<?= $case['cid']; ?>"
        class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> ADD
    </a>
    </td>
</tr>
    <?php                                      
