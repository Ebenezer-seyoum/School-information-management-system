  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title fw-bold" id="classSubjectsModalLabel">Subjects & Marks</h5>
...
$(function(){
    ...
    // --- Show sections/classes for the selected academic year ---
                    ...
                    html += `
                        <div class="col-md-4">
                          <div class="card shadow-sm border-0 rounded-3 p-3 h-100">
                            ...
                            <button class="btn btn-outline-primary btn-sm viewSubjectsBtn" data-id="${cls.cid}" data-year="${year}">View Marks</button>
                          </div>
                        </div>
                    `;
                });
    ...
    // --- Show subjects & marks in modal ---
    $(document).on('click', '.viewSubjectsBtn', function(){
        const sectionId = $(this).data('id');
        const year = $(this).data('year');

        $.post('fetch_class_marks.php', {section_id: sectionId, academic_year: year}, function(res){
            let html = '';
            if(res.length === 0){
