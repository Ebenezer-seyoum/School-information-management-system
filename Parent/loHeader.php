...
<link rel="icon" href="../assets/img/icon.png" type="image/x-icon"/>
	...
	custom: {"families":["Font Awesome 5 Solid","Font Awesome 5 Regular",
...
<div class="sidebar-wrapper scrollbar scrollbar-inner">
 <div class="sidebar-content">
   <ul class="nav nav-secondary">
    ...
    <a href="law_officer.php" class="collapsed"><i class="fas fa-home"></i><p>Low officer</p></a></li>
<li class="nav-item">
  <a data-bs-toggle="collapse" href="#cases"><i class="fas fa-folder-open"></i> <p>Manage Cases</p><span class="caret"></span></a>
  <div class="collapse" id="cases">
    <ul class="nav nav-collapse">
      <li><a href="register_case.php"><i class="fas fa-plus-circle"></i> Register Case</a></li>
      <li><a href="view_litigant_register.php"><i class="fas fa-user-plus"></i> Register Litigant</a></li>
	  <li><a href="view_case.php"><i class="fas fa-folder-open"></i> View All Cases</a></li>
    </ul>
  </div>
</li>
<li class="nav-item">
  <a data-bs-toggle="collapse" href="#caseInfo"><i class="fas fa-th-list"></i><p>Register Case Info</p><span class="caret"></span></a>
  <div class="collapse" id="caseInfo">
    <ul class="nav nav-collapse">
	  <li><a href="add_reason.php"><i class="fas fa-file-contract"></i> Register Reason</a></li>			
      <li><a href="add_case_type.php"><i class="fas fa-file-contract"></i> Register Case Type</a></li>
    </ul>
  </div>
</li>
<li class="nav-item">
    <a data-bs-toggle="collapse" href="#management"><i class="fas fa-balance-scale"></i><p>Cases status</p>
...
if (isset($_SESSION["uid"]) and ($profile["user_type"] == "Law_officer")) {
...
<li class="nav-item topbar-user dropdown hidden-caret">
 <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
	...
	<span class="profile-username"><span class="op-7"><?php echo "$profile[username]";?></span> <span class="fw-bold"></span></span></a>
