    ...
    <div class="container">
      <div class="row slider-text align-items-center justify-content-center">
        <div class="col-lg-12 text-center col-sm-12">
          ...
          <h1 class="mb-4" data-aos="fade-up" data-aos-delay="100">Balela Secondary School.</h1>
    ...
    <div class="container-fluid">
      <div class="row mb-5 no-gutters">
        <div class="col-sm-6 col-md-6 col-lg-6" data-aos="fade" data-aos-delay="100">
          <a href="portfolio-single.php" class="work-thumb">
            <div class="work-text">
              <h2>Startup Brand</h2>
              <p>Business</p>
            </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6" data-aos="fade" data-aos-delay="200">
          <a href="portfolio-single.php" class="work-thumb">
            ...
            <img src="Home/images/work_2.jpg" alt="Image" class="img-fluid">
          </a>
        </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6" data-aos="fade" data-aos-delay="300">
          <a href="portfolio-single.php" class="work-thumb">
            ...
            <img src="Home/images/work_3.jpg" alt="Image" class="img-fluid">
          </a>
        </div>
      ...
      <div class="row mt-5">
        <div class="col-12 text-center">
          <p><a href="portfolio.php" class="btn btn-outline-white px-4 py-3">More Portfolio</a></p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 order-1">
          <figure class="img-dotted-bg">
            <img src="Home/images/about_1.jpg" alt="Image" class="img-fluid">
            <img src="Home/images/work_1.jpg" alt="Image" class="img-fluid img-absolute" data-aos="fade-left">
