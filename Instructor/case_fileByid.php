    ...
    <tr>
      ...
      <td style="border: 2px solid black;">
       ...
       if (!empty($filePath) && file_exists($filePath)) {
           ...
           echo '<span class="text-muted">Main file not found</span>';
       }
       ?>
      </td>
...
if (!empty($attachedFiles)) {
  ...
  $no++;
    ...
    echo '<tr><td colspan="3" class="text-center text-danger" style="border: 2px solid black;">No cases found.</td></tr>';
}
?>
</tbody>
...
<div class="mt-3">
  <a href="case_detail.php?case_id=<?= $case['case_id'];?>&cid=<?= $case['cid'];?>" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Back</a>
</div>
      </div>
    </div>
  </div>
