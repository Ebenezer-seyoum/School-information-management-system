...
?>                                                                   
   <tr>
    ...
    <td style="border: 2px solid black;"> 
      <a href="case_detail.php?case_id=<?php echo $case["case_id"]; ?>&cid=<?= $case['cid'];?>"
       class="btn btn-primary btn-sm"><i class="fas fa-edit"></i>Details</a>
      </a>
    </td>
   </tr>
   <?php  
