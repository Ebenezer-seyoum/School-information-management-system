...
<div class="container">
  <div class="page-inner">
     <div class="page-header">
       <h3 class="fw-bold mb-3"> pending_appointment Cases</h3>
    <ul class="breadcrumbs mb-3">
         <li class="nav-home"><a href="#"><i class="icon-home"></i></a></li>
         <li class="separator"><i class="icon-arrow-right"></i></li>
         <li class="nav-item"><a href="#">Case Status</a></li>
         <li class="separator"><i class="icon-arrow-right"></i></li>
         <li class="nav-item"><a href="#">pending_appointment Cases</a></li>
    </ul>
 </div>
<!-- End Page Header -->
     ...
     <div class="card-header">
      <div class="row w-100 align-items-center">
        <div class="col-12 col-md-6 mb-2 mb-md-0">
          <h4 class="mb-0">pending_appointment cases</h4>
        </div>
...
<?php
  if (isset($_SESSION["uid"])) {
      if (isset($_GET['search']) && !empty(trim($_GET['search']))) {
          ...
          $cases = getAssignedCasesByIdPendingAppointmentStatus($judge_id);
      }
?>
<div class="card-body">
