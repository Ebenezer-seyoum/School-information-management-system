...
<footer>
        ...
        <div class="row">
            <div class="col-12 col-sm-3 col-md-3 col-lg-3 p-0 ">
                <div class="shape_wrapper">
                    <img src="Home/images/shapes/bubble_shpe_1.png" alt="" class="shape_t_1"> 
                    <img src="Home/images/shapes/round_shpae_1.png" alt="" class="shape_t_2">
                </div>   
            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="footer_single_col footer_intro">
                        <img src="Home/images/logo2.png" alt="" class="f_logo">
    ...
    <img src="Home/images/shapes/footer_bg_shpe_1.png" alt="" class="shapes1_footer">
</footer><!-- End Footer -->
...
<section id="scroll-top" class="scroll-top">
    ...
    <!-- Revolution Slider -->
    <script src="Home/js/assets/revolution/jquery.themepunch.revolution.min.js"></script>
    <script src="Home/js/assets/revolution/jquery.themepunch.tools.min.js"></script> 
    ...
    <script src="Home/js/assets/revolution/extensions/revolution.extension.actions.min.js"></script>
    <script src="Home/js/assets/revolution/extensions/revolution.extension.carousel.min.js"></script>
    <script src="Home/js/assets/revolution/extensions/revolution.extension.kenburn.min.js"></script>
    <script src="Home/js/assets/revolution/extensions/revolution.extension.layeranimation.min.js"></script>
    <script src="Home/js/assets/revolution/extensions/revolution.extension.migration.min.js"></script>
    <script src="Home/js/assets/revolution/extensions/revolution.extension.navigation.min.js"></script>
    <script src="Home/js/assets/revolution/extensions/revolution.extension.parallax.min.js"></script>
    <script src="Home/js/assets/revolution/extensions/revolution.extension.slideanims.min.js"></script>
    <script src="Home/js/assets/revolution/extensions/revolution.extension.video.min.js"></script>
    <script src="Home/js/assets/revolution/revolution.js"></script>
    ...
    ============================================================== -->
    <script type="text/javascript" src="Home/js/demo.js"></script>
    <div class="demo-style-switch" id="switch-style">
        <a id="toggle-switcher" class="switch-button" title="Change Styles"><span class="fa fa-cog fa-spin"></span></a>
        <div class="switched-options">
            <div class="config-title">
                <a class="navbar-brand" href="index-2.html"><img src="Home/images/logo.png" alt="logo"></a>
