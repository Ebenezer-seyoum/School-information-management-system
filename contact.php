<?php
include "Home/contactheader.php";
?>
                 ...
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        ...
                        <div class="pages_links">
                            ...
                            <a href="contact.php" title="" class="active">Contact Details</a>
                        </div>
                    </div>
                </div>              
            </div>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                <div class="contact_info">
                    ...
                    <div class="event_location_info">                  
                        ...
                        <img src="Home/images/banner/map_shape.png" alt="" class="contact__info_shpae">
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
