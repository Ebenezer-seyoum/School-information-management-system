            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group col-6 text-center">
                  ...
                  <a href="viewCase_detailByid.php?case_id=&cid=" class="btn btn-primary mt-2">View Litigant Details</a>
                </div>
                <div class="form-group col-6 text-center">
                  <label for="file">File Details</label><br>
                  <a href="view_filedetailByid.php?case_id=&cid=" class="btn btn-secondary mt-2">View File Details</a>
                </div>
              </div>
            </div>
          </div>
