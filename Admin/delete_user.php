              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-hover align-middle text-center"
                    style="border: 2px solid black; border-collapse: collapse; width: 100%; background-color: white;">
                    ...
                    <tbody>
                      <!-- Placeholder row -->
                      <tr>
                        <td colspan="8" class="text-center text-muted" style="border: 2px solid black;">
                          No users loaded (PHP logic removed).
                        </td>
                      </tr>
                    </tbody>
                  </table>
