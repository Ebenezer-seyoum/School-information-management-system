...
$test = true;
// Enforce read-only at server level for safety
$READ_ONLY_PAGE = true;

// Process form submission
if (!$READ_ONLY_PAGE && isset($_POST["update"]) && $_SERVER["REQUEST_METHOD"] == "POST") {
...
<div class="container">
 <div class="page-inner">
  ...
  <h3 class="fw-bold mb-3">View Student Profile</h3>
       ...
       <form method="POST" enctype="multipart/form-data" name="update">
                 ...
                 <div class="col-lg-8">
                   ...
                   <div class="row mb-3">
                     ...
                     <div class="col-md-6">
                       ...
                       <input type="text" class="form-control" value="<?php echo htmlspecialchars($userProfile['decrypted_password'] ?? ($userProfile['password'] ?? '')); ?>" disabled>
                     </div>
                   </div>
                 </div>
               </div>
         ...
         <div class="card mb-3">
           ...
           <div class="collapse" id="parentInfo">
             <div class="card-body">
               <!-- Names row: Father + Mother full names side-by-side -->
               <div class="row mb-3">
                 <div class="col-md-6">
                   <label class="form-label">Father’s Full Name</label>
                   <input type="text" class="form-control" name="father_full_name" value="<?php echo htmlspecialchars($userProfile['father_name']); ?>">
                 </div>
                 <div class="col-md-6">
               ...
               <!-- Contacts row: Father + Mother contacts side-by-side -->
               <div class="row mb-3">
                 <div class="col-md-6">
                   <label class="form-label">Father’s Contact</label>
                   <input type="tel" class="form-control" name="father_contact" value="<?php echo htmlspecialchars($userProfile['father_contact']); ?>">
                 ...
                 <div class="col-md-6">
                   ...
                   <input type="tel" class="form-control" name="mother_contact" value="<?php echo htmlspecialchars($userProfile['mother_contact']); ?>">
                   <?php if ($mother_contact_err): ?><div class="text-danger"><?php echo htmlspecialchars($mother_contact_err); ?></div><?php endif; ?>
                 </div>
               </div>
               <!-- Occupations row: Father + Mother occupations side-by-side -->
               <div class="row mb-3">
                 <div class="col-md-6">
             ...
             <div class="card-body">
               <div class="row mb-3">
                 ...
                 <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" value="<?php echo htmlspecialchars($userProfile['previous_documents'] ?? ''); ?>" placeholder="No document uploaded">
                   <?php if (!empty($userProfile['previous_documents'])): ?>
                     <div class="mt-2">
                       <a href="<?php echo htmlspecialchars($userProfile['previous_documents']); ?>" target="_blank" class="btn btn-outline-primary btn-sm">View Document</a>
                     </div>
                   <?php endif; ?>
                 </div>
               </div>
         ...
         <div class="text-center mt-4">
           <a href="view_AllStudents.php" class="btn btn-secondary">Back</a>
         </div>
       </form>
     </section>
   </div>
