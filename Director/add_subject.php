                                                                        ...
                                                                        <div class="form-group mt-3">
                                                                                ...
                                                                                <div class="row g-3"> <!-- g-3 = spacing between cards -->
                                                                                                                                    <?php foreach ($ordered_groups as $class_type => $secs) { ?>
                                                                                                                                        <div class="col-12 col-md-4"> <!-- Show GENERAL, NATURAL, SOCIAL horizontally -->
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        document.querySelectorAll('input.btn-check[name="section_ids[]"]').forEach(function(cb){
            cb.addEventListener('change', function(){
                ...
                // classList includes 'btn-check' and group name
...
<style>
    /* Visual hint for Select All checkbox by state */
