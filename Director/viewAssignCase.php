...
<div class="container">
  <div class="page-inner">
    <div class="page-header">
       <h3 class="fw-bold mb-3">View Assign Judges</h3>
        <ul class="breadcrumbs mb-3">
            <li class="nav-home"><a href="#"><i class="icon-home"></i></a></li>
            <li class="separator"><i class="icon-arrow-right"></i></li>
            <li class="nav-item"><a href="#">Case Management</a></li>
            <li class="separator"><i class="icon-arrow-right"></i></li>
            <li class="nav-item"><a href="#">View Assign Judges</a></li>
        </ul>
</div>
<div class="row">
  <div class="col-12">
    ...
    <div class="col-12 col-md-6 mb-2 mb-md-0">
      <h4 class="mb-5">View Assign Judges</h4>
    </div>
...
<?php
  if (isset($_SESSION["uid"])) {
      if (isset($_GET['search']) && !empty(trim($_GET['search']))) {
          ...
          $cases = getAssignedCasesDisplayOnce();
      }
?>
...
<tr>
  ...
  <td style="border: 2px solid black;"><?= $status; ?></td>
    ...
    <a href="view_assignJudgesById.php?case_id=<?= $case["cid"]; ?>"class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Details
    </a>
    </td>
</tr>
<?php  
