      ...
      <div class="col-12 col-sm-12 col-lg-12">
        ...
        if (isset($_SESSION["uid"])) {
            if (isset($_GET['search']) && !empty(trim($_GET['search']))) {
                ...
                $cases = getAssignedCasesByJudge($judge_id);
            }
        ?>
<div class="card-body">
  ...
  <?php
    ...
    <tr>
        ...
        <?php $case['cid']; ?>
        <a href="transfer_case.php?case_id=<?= $case['case_id']; ?>&cid=<?= $case['cid']; ?>&judge_id=<?= $judge_id; ?>" class="btn btn-primary btn-sm">
         <i class="fas fa-edit"></i> Transfer
        </a>
        </td>
    </tr>
    <?php  
...
<?php } ?>
   ...
   <div class="text-left mt-4">
                <a href="view_transfer_cases.php" class="btn btn-outline-primary">
