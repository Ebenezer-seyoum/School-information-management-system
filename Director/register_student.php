    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="form-group col-md-6 mb-3">
          ...
          <input type="text" name="father_full_name" id="father_full_name" class="form-control">
          <span class="text-danger"><?php echo htmlspecialchars($father__full_name_err); ?></span>
        </div>
        ...
        <div class="form-group col-md-6 mb-3">
          ...
          <input type="text" name="father_contact" id="father_contact" class="form-control">
        ...
        <!-- Mother -->
          ...
          <input type="text" name="mother_contact" id="mother_contact" class="form-control">
...
<div class="form-group col-md-6 mb-3" id="other_condition_group" style="display:none;">
