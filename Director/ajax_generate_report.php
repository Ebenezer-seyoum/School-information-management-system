...
$mode          = $_GET['mode'] ?? 'download'; // 'download' or 'preview'
...
$html1 = "
<h2 style='text-align:center;'>የተማሪ ደብዳቤ | STUDENT REPORT CARD</h2>
<p style='text-align:center;'>Academic Year / የትምህርት አመት: $academic_year</p>
<h3>Student Information / የተማሪ መረጃ</h3>
<table border='1' cellpadding='5'>
<tr><td>Name / ስም</td><td>$studentFullName</td></tr>
<tr><td>Gender / ፆታ</td><td>{$student['gender']}</td></tr>
<tr><td>Age / እድሜ</td><td>$age years</td></tr>
<tr><td>Address / አድራሻ</td><td>{$student['woreda']}, {$student['kebele']}</td></tr>
<tr><td>Class / ክፍል</td><td>$section_id</td></tr>
<tr><td>Promotion Status / የማሻሻያ ሁኔታ</td><td>$promotionStatus</td></tr>
</table>
";
...
// --- Footer ---
$mpdf->SetFooter('Generated by School Management System / የተፈጥሮ ከመማሪያ ስርዓት');
