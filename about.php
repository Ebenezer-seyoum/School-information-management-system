                 ...
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        ...
                        <div class="pages_links">
                            ...
                            <a href="about.php" title="" class="active">About Page</a>
                        </div>
                    </div>
                </div>              
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-5 col-lg-5 p-0">
                <div class="banner_about">
                    <img src="Home/images/banner/about_thinking.jpg" alt="" class="img-fluid">
                 </div>
            </div>
        </div>        
        <div class="row about_content_wrapper">
            <div class="col-12 col-sm-12 col-md-5 col-lg-5 p-0">
                <div class="about_banner_down">
                    <img src="Home/images/blog/blog_3.jpg" alt="" class="img-fluid">
                 </div>
            </div>
            <div class="col-12 col-sm-12 col-md-7 col-lg-7">
