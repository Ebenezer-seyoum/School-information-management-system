...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">View judges</h3>
            <ul class="breadcrumbs mb-3">
                <li class="nav-home"><a href="#"><i class="icon-home"></i></a></li>
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="#">Judges Detail</a></li>
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="#">View Judges</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="input-group">
       ...
       <?php $caseCount = getAssignedCaseCount($user['uid']); ?>
<a href="view_assignedCasesById.php?uid=<?php echo $user['uid']; ?>" 
   class="btn btn-success btn-sm w-50 mt-2">
    🗂 <?php echo $caseCount; ?> Case<?php echo $caseCount != 1 ? 's' : ''; ?>
</a>
                            </div>
                        </div>
                    </div>
