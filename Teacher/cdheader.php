			...
			<div class="sidebar-content">
				<ul class="nav nav-secondary">
					<li class="nav-item active">
						<a href="case_distributer.php" class="collapsed"><i class="fas fa-home"></i><p>Case distributer</p></a>
					</li>
					<li class="nav-item">
						<a data-bs-toggle="collapse" href="#judgeControl"><i class="fas fa-user-tie"></i><p>Judge Control</p><span class="caret"></span></a>
						<div class="collapse" id="judgeControl">
							<ul class="nav nav-collapse">
								<li><a href="view_student.php"><i class="fas fa-gavel"></i>View students</a></li>					
							</ul>
						</div>
					</li>
					<li class="nav-item">
						<a data-bs-toggle="collapse" href="#caseManagement"><i class="fas fa-briefcase"></i><p>Case Management</p><span class="caret"></span></a>
					...
					<li class="nav-item">
						<a data-bs-toggle="collapse" href="#caseStatus"><i class="fas fa-balance-scale"></i><p>Case Status</p><span class="caret"></span></a>
						...
						<ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
							...
							<li class="nav-item topbar-user dropdown hidden-caret">
								<a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
									<div class="avatar-sm">
										<img class="profile-img" src="#" alt="Profile Picture" width="100" height="100">
									</div>
									<span class="profile-username"><span class="op-7">Username</span></span>
								</a>
