<?php
include('teacherHeader.php'); // ✅ use teacher header
...
<div class="container">
  <div class="page-inner">
    <div class="page-header">
      <h3 class="fw-bold mb-3">My Reports</h3>
      <ul class="breadcrumbs mb-3">
        <li class="nav-home"><a href="#"><i class="icon-home"></i></a></li>
        <li class="separator"><i class="icon-arrow-right"></i></li>
        <li class="nav-item"><a href="#">Reports</a></li>
        <li class="separator"><i class="icon-arrow-right"></i></li>
        <li class="nav-item"><a href="#">My Reports</a></li>
      </ul>
    </div>
        ...
        <form method="GET" action="">
          <div class="row g-2">
            ...
            <div class="col-md-3 align-self-end">
              <a href="subject_report.php" class="btn btn-secondary btn-sm w-100">Reset Filters</a>
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="reportTable" class="table table-hover table-bordered text-center" style="width:100%;">
            ...
            <tbody>
              <?php
$sql = "SELECT sub.subject_name, sec.section_name, sec.class_type, 
               at.section_id, at.subject_id, at.academic_year
        FROM assign_teacher at
        JOIN subjects sub ON at.subject_id=sub.suid
        JOIN sections sec ON at.section_id=sec.cid
        WHERE at.teacher_id='$teacher_id'";
...
if(mysqli_num_rows($res) > 0){
    ...
    while($r = mysqli_fetch_assoc($res)){
        ...
        $student_sql = "SELECT COUNT(DISTINCT m.student_id) AS student_count, 
                        ...
                        WHERE m.section_id='".mysqli_real_escape_string($conn,$section_id_row)."' 
...
$(function(){
  if ($.fn.DataTable && $.fn.dataTable && $.fn.dataTable.Buttons) {
    var $tbl = $('#reportTable');
    // Remove any rows with mismatched column counts to avoid DataTables alert
    ...
    $tbl.DataTable({
      ...
      language: { emptyTable: 'No reports found' },
      buttons: [
