...
<div class="container">
         <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">View All Cases</h3>
    <ul class="breadcrumbs mb-3">
        <li class="nav-home"><a href="#"><i class="icon-home"></i></a></li>
         <li class="separator"><i class="icon-arrow-right"></i></li>
         <li class="nav-item"><a href="#">Manage Cases</a></li>
        <li class="separator"><i class="icon-arrow-right"></i></li>
         <li class="nav-item"><a href="#">View All Cases</a></li>
    </ul>
 </div>
<!-- End Page Header -->
 <!-- Main Content -->
  ...
  <thead class="table-secondary">
   ...
   <tr>
    ...
    <td style="border: 2px solid black;"> 
      <a href="caseinfo_register.php?case_id=<?php echo $case["case_id"]; ?>"
      class="btn btn-primary btn-sm"><i class="fas fa-edit"></i>ADD</a>
    </td>
   </tr>
   <?php  
       $no++; }
